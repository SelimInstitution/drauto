...
<body>
                ...
                <td>
	                <div>
		                <select name="sbscrbSttus" id="sbscrbSttus" title="검색조건선택1">
		                    ...
		                    <option value="A" <c:if test="${mberVO.sbscrbSttus == 'A'}">selected="selected"</c:if> >신청</option>
        ...
        <br/>
        <table width="99%" cellpadding="8" class="table-search" border="0">
            <tr>
                ...
                <td><span class="button"><a href="<c:url value='/uss/umt/EgovMberInsertView.do'/>" onclick="fnAddUserView(); return false;"><spring:message code="button.create" /></a></span>&nbsp;</td>
                <td><span class="button"><a href="<c:url value='/uss/umt/EgovMberInsertView.do'/>" onclick="fnAddUserView(); return false;"><spring:message code="button.update" /></a></span>&nbsp;</td>
            </tr>            
        </table>
        <table summary="List of Sample"  width="99%" cellpadding="8" class="table-line">
            <thead>
                <tr>
                    ...
                    <th class="title" scope="col">소속</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="lt_text3" ><c:out value="${result.psitn}"/></td>
