...
<!-- content start -->
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            <tr>
              <td width="100%" class="title_left"><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="" />&nbsp;회원 신청</td>
            </tr>
        </table>
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            ...
            <tr>
                <th width="20%" height="23" class="required_text"  >
                    이름<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시" />
                </th>
                <td width="80%" >
            ...
            <tr>
                <th width="20%" height="23" class="required_text">
                    이메일<img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시" />
                </th>
                <td width="80%">
            ...
            <%-- 
            <tr>
                <th width="20%" height="23" class="required_text">소속&nbsp;&nbsp;</th>
                <td width="80%">
                    <form:input path="psitn" id="psitn" title="소속" cssClass="txaIpUmt" size="20" maxlength="50" />
