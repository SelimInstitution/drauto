...
function fnIdCheck(){
    ...
    var openParam = "dialogWidth:303px;dialogHeight:160px;scroll:no;status:no;center:yes;resizable:yes;";
...
function fnListPage(){
    document.mberManageVO.action = "<c:url value='/Login.do'/>";
    document.mberManageVO.submit();
}
...
function fnInit() {
	var message = document.mberManageVO.message.value;
    if (message != "") {
        alert(message);
        fnClose()
    }
...
<body  onLoad="fnInit();">
        ...
        <table width="435" cellpadding="8" class="table-search" border="0">
            <tr>
        ...
        <table width="435" border="0" cellpadding="0" cellspacing="1" class="table-register">
            <tr>
            ...
            <tr>
                ...
                <td width="70%" nowrap>
                    <form:input path="psitn" cssClass="txaIpUmt" size="30" maxlength="50" />
                    <div><form:errors path="psitn" cssClass="error" /></div>
                </td>
            </tr>
            <%-- 
            <tr>
            ...
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0" align="center">
		            <tr>
		                ...
		                <td background="<c:url value='/images/egovframework/com/cmm/btn/bu2_bg.gif' />" class="text_left" nowrap><a href="javascript:fnSbscrb()"><spring:message code="button.subscribe" /></a></td>
		                <td><img src="<c:url value='/images/egovframework/com/cmm/btn/bu2_right.gif' />" width="8" height="20" alt="버튼이미지"></td>
		                <td>&nbsp;</td>		                
		                <td><span class="button"><a href="<c:url value='/uss/umt/EgovMberSbscrbView.do'/>" onclick="fnClose();"><spring:message code="button.close" /></a></span>&nbsp;</td>
