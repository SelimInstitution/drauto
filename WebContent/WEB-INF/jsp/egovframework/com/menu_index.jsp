...
<frameset rows="90,*,50" frameborder="0" >
	...
	<frameset cols="240,*" frameborder="0">
		...
		<frame src="<c:url value='/sym/mnu/mpm/EgovMainMenuRight.do' />?vStartP=<c:out value="${resultVO.menuNo}" />" name="main_right" marginwidth="0" marginheight="0" margin-right="15px">
	</frameset>
