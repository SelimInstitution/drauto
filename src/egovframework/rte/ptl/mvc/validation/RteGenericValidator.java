 ...
 * <p><b>NOTE:</b> <pre> 실제적인 validation check 로직을 수행한다.
...
public class RteGenericValidator implements Serializable {
	...
	for (int i = 0; i < charArray.length; i++) {
	    char ch = charArray[i];
	    /*
	     * // javascript 부분에는 33~47로 되어 있으나 공백을 처리하기 위해 32~47로 변경함.. if ((ch
	     * >= 32 && ch <= 47) || (ch >= 58 && ch <= 64) || (ch >= 91 && ch
	     * <= 96) || (ch >= 123 && ch <= 126)) { return false; }
	     */
