...
public class EgovMberManageController {
    ...
    public String updateMber(
        ...
        System.out.println("11"+mberManageVO.getPassword());
        System.out.println("22"+bindingResult);
        
    	beanValidator.validate(mberManageVO, bindingResult);
    	System.out.println("222"+bindingResult.hasErrors());
    ...
    public String sbscrbMber(
        ...
        return "forward:/uss/umt/EgovMberSbscrbView.do";
    }
