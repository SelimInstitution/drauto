...
//        	System.out.println("11>>"+resultVO.getId());
        	// 2-1. 로그인 정보를 세션에 저장
...
//        	System.out.println("22>>"+resultVO.getId());
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/drauto/login/drautoLogin.do")
    public String smbsLogin(@ModelAttribute("loginVO") LoginVO loginVO, 
    		                   HttpServletRequest request,
    		                   ModelMap model)
            throws Exception {
...
//        	System.out.println("로그인 정보");
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/drauto/login/drautoLogout.do")
	public String smbsLogout(HttpServletRequest request, ModelMap model) 
			throws Exception {
