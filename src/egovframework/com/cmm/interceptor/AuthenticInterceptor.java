	...
	public boolean preHandle(HttpServletRequest request,
		...
		if (loginVO != null) {
			...
			if (requestURI.endsWith("Login.do") 
				|| requestURI.endsWith("validator.do")
				|| requestURI.endsWith("EgovMberSbscrb.do") 
				|| requestURI.endsWith("EgovMberSbscrbView.do")
				|| requestURI.endsWith("EgovIdDplctCnfirm.do")
				|| requestURI.endsWith("EgovIdDplctCnfirmView.do")) {
				return true;
			}
			
			ModelAndView modelAndView = new ModelAndView("redirect:/html/loginfail.html");
